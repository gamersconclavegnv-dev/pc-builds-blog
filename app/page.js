...
const CPU_TIERS = [
  ...
  { match: /9900x/i,   score: 9500 },
  { match: /9700x/i,   score: 8800 },
  { match: /9600x/i,   score: 8000 },
  // Ryzen 7000 (AM5)
  { match: /7950x3d/i, score: 9800 },
  { match: /7900x3d/i, score: 9400 },
  { match: /7800x3d/i, score: 9000 },
  { match: /7950x/i,   score: 9200 },
  { match: /7900x/i,   score: 8800 },
  { match: /7700x/i,   score: 7800 },
  ...
  { match: /i9-1[34][0-9]{3}/i,   score: 8800 },
  { match: /i7-1[34][0-9]{3}k/i,  score: 8200 },
  { match: /i7-1[34][0-9]{3}/i,   score: 7600 },
  { match: /i5-1[34][0-9]{3}k/i,  score: 7200 },
  { match: /i5-1[34][0-9]{3}/i,   score: 6600 },
  // Intel 12th gen
  { match: /i9-12[0-9]{3}k/i,     score: 8400 },
  { match: /i9-12[0-9]{3}/i,      score: 8000 },
  { match: /i7-12[0-9]{3}k/i,     score: 7600 },
  { match: /i7-12[0-9]{3}/i,      score: 7100 },
  { match: /i5-12[0-9]{3}k/i,     score: 6800 },
  { match: /i5-12[0-9]{3}/i,      score: 6300 },
  // Ryzen 5000 (AM4)
  { match: /5950x/i,   score: 8200 },
  { match: /5900x/i,   score: 7800 },
  { match: /5800x3d/i, score: 8000 },
  { match: /5800x/i,   score: 7200 },
  { match: /5800/i,    score: 6800 },
  { match: /5700x/i,   score: 6600 },
  { match: /5700g/i,   score: 6200 },
  { match: /5700/i,    score: 6400 },
  { match: /5600x/i,   score: 6400 },
  { match: /5600g/i,   score: 5800 },
  { match: /5600/i,    score: 6000 },
  { match: /5500/i,    score: 5400 },
  // Intel 10th/11th gen
  ...
  // Ryzen 3000 (AM4)
  { match: /3950x/i,   score: 6400 },
  { match: /3900x/i,   score: 6200 },
  { match: /3800x/i,   score: 5800 },
  { match: /3700x/i,   score: 5600 },
  { match: /3700/i,    score: 5200 },
  { match: /3600x/i,   score: 5200 },
  { match: /3600/i,    score: 4800 },
  { match: /3500x/i,   score: 4400 },
  { match: /3500/i,    score: 4200 },
  // Intel 8th/9th gen
  { match: /i9-9[0-9]{3}k/i,      score: 5800 },
  { match: /i7-9[0-9]{3}k/i,      score: 5400 },
  { match: /i7-[89][0-9]{3}/i,    score: 4800 },
  { match: /i5-[89][0-9]{3}k/i,   score: 4600 },
  { match: /i5-[89][0-9]{3}/i,    score: 4200 },
  // Ryzen 1000/2000 (AM4)
  { match: /2700x/i,   score: 4200 },
  { match: /2700/i,    score: 3800 },
  { match: /2600x/i,   score: 3600 },
  { match: /2600/i,    score: 3400 },
  { match: /1800x/i,   score: 3600 },
  { match: /1700x/i,   score: 3400 },
  { match: /1700/i,    score: 3200 },
  { match: /1600x/i,   score: 3000 },
  { match: /1600/i,    score: 2800 },
  // Older Intel
